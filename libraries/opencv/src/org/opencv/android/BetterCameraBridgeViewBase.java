...
public abstract class BetterCameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private Matrix rotateMe(Canvas canvas, Bitmap bm) {
        ...
        float scale = (float) canvasWidth / (float) (bmHeight);
        ...
        mtx.postRotate(90, canvasWidth/2, canvasHeight/2 );
        mtx.postScale(scale, scale, canvasWidth / 2, canvasHeight / 2);
        mtx.preTranslate((canvasWidth - bmWidth)/2, (canvasHeight - bmHeight)/2);
        //mtx.preTranslate((canvasWidth - bmWidth)/2, (canvasHeight - bmHeight)/2);
        //mtx.preScale(2,0,0,2);
        return mtx;
    }
    ...
    protected Size calculateCameraFrameSize(List<?> supportedSizes, ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        ...
        Log.d(TAG, "CameraBridgeViewBase---- mMaxWidth: " + mMaxWidth);
        Log.d(TAG, "CameraBridgeViewBase---- mMaxHeight: " + mMaxHeight);
        for (Object size : supportedSizes) {
            int width = accessor.getWidth(size);
            int height = accessor.getHeight(size);
            Log.d(TAG, "SUPPORTED SIZES in CameraBridgeViewBase (w/h):" + width + "/" + height);
        ...
        Log.d(TAG, "calcWidth:" + calcWidth);
        Log.d(TAG, "calcHeight:" + calcHeight);
